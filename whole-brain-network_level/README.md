...
- [1.0_bootstrap_beta_fa.py](1.0_bootstrap_beta_fa.py) 
- [1.0_bootstrap_beta_sa.py](1.0_bootstrap_beta_sa.py)
  - Bootstrap over 1,000 times to reconstruct the confidence interval for every voxel 
- [2.0_fa_bootstrap_significance.py](2.0_fa_bootstrap_significance.py) 
- [2.0_sa_bootstrap_significance.py](2.0_sa_bootstrap_significance.py)
