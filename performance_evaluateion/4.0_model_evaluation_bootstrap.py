...
# load data 
    ...
    if 'test' in args.data_type:
        boot_dic = boot_to_ci(test_data_matrix, boot_size, avg_weights, avg_intercepts)
    else:
        boot_dic = boot_to_ci(transfer_data_matrix, boot_size, avg_weights, avg_intercepts)
