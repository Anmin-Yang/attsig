"""
Prepare X and Y matrices for classification to find significant voxels

1. Rule out participants for poor signal
2. Generate Nan_mask as the union of usable voxels
3. Divide subjects into train and test datasets
4. Concate X and Y matrices for prediction
"""
...
root_path = '/data/home/attsig/attention_signature/attention_from_liu/attention_data_complete/data'
...
save_path = '/data/home/attsig/attention_signature/attention_from_liu/attention_data_complete/train_test_data'

np.save(os.path.join(save_path,'mask_NaN'),mask_NaN)
