...
for i = 1:length(subjs)
    ...
    if selection{i} == 1 && behavior{i} == 1
        %input SPM.mat data
        spmPath =  ['/nfs/e2/workingshop/tianjinhua/NSP_attention/nspSpm/data/',subj,'/1st_sa/SPM.mat'];
